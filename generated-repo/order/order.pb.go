...
const file_order_order_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2b\n" +
	"\x14OrderTrackingService\x12J\n" +
	"\x17SubscribeToOrderUpdates\x12\x13.order.OrderRequest\x1a\x18.order.OrderStatusUpdate0\x01B/Z-github.com/OkaSher/assignment-generated/orderb\x06proto3"
...
var file_order_order_proto_depIdxs = []int32{
	...
	0, // 1: order.OrderTrackingService.SubscribeToOrderUpdates:input_type -> order.OrderRequest
	1, // 2: order.OrderTrackingService.SubscribeToOrderUpdates:output_type -> order.OrderStatusUpdate
